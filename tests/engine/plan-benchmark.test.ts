...
// own so experiment 138 re-asks the verdict on *this* arithmetic rather than on a second copy of it. The
// ratio readings below stay here, beside the pins that read them.
