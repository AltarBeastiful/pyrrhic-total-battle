# 160 — the rated re-typing, shipped in the engine (unguarded: before `keepReadings`, recorded for the comparison)
...
|---|---|---|---|---:|---|---|---|---|---|---|---|---|---|---|---|---|---|---:|
| first-run army, Bear V ×1 (20 000 leader | 1 → 1 | 1 | 1 / 0 / 0 | 1.59 | **18,479,500 (+1.6 %)** | 32,525,600 | 1 | 0 | 0 | **2,524 h (−0.1 %)** | **0.568 (+1.6 %)** | 112,200 | 0 | — | 1 → 3 | 0 → 0 | ✓ | 25 ms |
| first-run army, Bear V ×2 (20 000 leader | 1 → 1 | 1 | 1 / 0 / 0 | 1.58 | **18,703,900 (+1.6 %)** | 32,525,600 | 2 | 160 | 0 | **2,524 h (−0.1 %)** | **0.575 (+1.6 %)** | 168,300 | **116,899 (+1.6 %)** | — | 1 → 3 | 0 → 0 | ✓ | 25 ms |
| first-run army, Bear V ×3 (20 000 leader | 2 → 2 | 2 | 2 / 0 / 0 | 1.55 | **19,040,500 (+1.5 %)** | 32,525,600 | 3 | 0 | 0 | **2,524 h (−0.1 %)** | **0.585 (+1.5 %)** | 224,400 | **39,668 (+1.5 %)** | — | 2 → 8 | 0 → 0 | ✓ | 24 ms |
| first-run army, Bear V ×10 (20 000 leade | 2 → 2 | 2 | 2 / 0 / 0 | 1.40 | **21,290,233 (+1.9 %)** | 32,525,600 | 4 | 3,200 | 0 | **2,524 h (−0.1 %)** | **0.647 (+1.4 %)** | 776,050 | **6,581 (+1.4 %)** | — | 2 → 4 | 0 → 0 | ✓ | 30 ms |
| first-run army, Epic Monster Hunter VI × | 4 → 4 | 4 | 4 / 0 / 0 | 0.98 | **30,140,049 (+1.0 %)** | 32,525,600 | 11 | 736 | 0 | **2,524 h (−0.1 %)** | **0.922 (+1.0 %)** | 423,145 | **30,998 (+1.3 %)** | — | 5 → 7 | 0 → 0 | ✓ | 62 ms |
| first-run army, monster tiers 3–5 at 900 | 5 → 5 | 5 | 5 / 0 / 0 | 0.22 | **103,197,710 (+0.2 %)** | **34,920,400 (+0.0 %)** | 15 | 9,424 | 24,120 | **2,863 h (−0.1 %)** | **2.766 (+0.2 %)** | 597,802 | **9,496 (+0.3 %)** | **3,816 (+0.2 %)** | 0 → 0 | 3 → 3 | ✓ | 139 ms |
| the 4 000-leadership case of 2026-09-15  | 3 → 3 | 3 | 3 / 0 / 0 | 2.84 | **8,985,057 (+5.5 %)** | **3,830,800 (−0.3 %)** | 19 | 736 | 0 | **237 h (+0.3 %)** | **1.476 (+5.4 %)** | 265,255 | **7,287 (+2.9 %)** | — | 6 → 10 | 0 → 0 | ✓ | 34 ms |
| 2026-09-17 export, its setup (7 000 lead | 5 → 5 | 5 | 4 / 0 / 0 | 1.25 | **24,291,732 (+3.1 %)** | **8,695,700 (−0.0 %)** | 26 | 2,112 | 0 | **583 h (−0.0 %)** | **2.216 (+6.7 %)** | 357,360 | **7,252 (+1.6 %)** | — | 6 → 6 | 3 → 3 | ✓ | 23 ms |
| 2026-09-17 export, 12 000 leadership | 4 → 4 | 4 | 4 / 0 / 0 | 3.34 | **34,617,571 (+8.3 %)** | **12,130,200 (−0.0 %)** | 30 | 2,408 | 0 | **814 h (−0.0 %)** | **1.833 (+4.5 %)** | 369,197 | **9,304 (+3.3 %)** | — | 3 → 3 | 2 → 2 | ✓ | 31 ms |
| live account of 2026-09-18 (one hired ty | 4 → 4 | 1 | 1 / 3 / 0 | 0.00 | 29,743,332 | **18,610,500 (+1.8 %)** | 20 | 1,368 | 0 | **1,310 h (+0.5 %)** | **0.981 (+1.9 %)** | 317,110 | 16,063 | — | 9 → 9 | 0 → 0 | ✓ | 6 ms |
| live account, evening (hunters 83, legio | 5 → 5 | 5 | 4 / 0 / 0 | 4.59 | **34,103,988 (+7.5 %)** | **12,350,700 (−0.1 %)** | 32 | 2,296 | 0 | **815 h (−0.1 %)** | **1.985 (+11.1 %)** | **332,927 (+10.4 %)** | **8,941 (+6.7 %)** | — | 1 → 6 | 0 → 0 | ✓ | 46 ms |
| Aydae alone, 4 975 (one captain, four hi | 4 → 4 | 4 | 4 / 0 / 0 | 0.03 | **18,750,522 (+0.0 %)** | **5,777,000 (−0.2 %)** | 19 | 1,288 | 0 | **323 h (+0.3 %)** | **2.089 (+0.1 %)** | 325,749 | **7,337 (+0.2 %)** | — | 0 → 0 | 0 → 0 | ✓ | 16 ms |
| the owner’s live camp of 2026-09-18 (arb | 5 → 5 | 5 | 5 / 0 / 0 | 1.79 | **31,541,795 (+1.8 %)** | **6,914,500 (−2.1 %)** | 16 | 1,448 | 0 | **476 h (+0.1 %)** | **2.586 (+1.8 %)** | **257,643 (+10.7 %)** | **6,092 (+6.8 %)** | — | 0 → 0 | 0 → 0 | ✓ | 10 ms |
| his camp of 2026-09-19, the localStorage | 5 → 5 | 4 | 4 / 1 / 0 | 0.00 | 23,589,127 | **7,410,500 (−1.3 %)** | 6 | 392 | 0 | **510 h (−0.1 %)** | 1.808 | 318,189 | **17,713 (+4.6 %)** | — | 2 → 2 | 1 → 1 | ✓ | 32 ms |
| his camp of 2026-09-19, as his message r | 5 → 5 | 5 | 4 / 0 / 0 | 0.75 | **11,587,344 (+0.0 %)** | **7,718,500 (+7.8 %)** | 15 | 1,056 | 0 | **653 h (+13.7 %)** | **1.167 (+9.2 %)** | 258,218 | **7,011 (+0.0 %)** | — | 2 → 2 | 1 → 1 | ✓ | 9 ms |
| his TotalStack profile of 2026-09-19 (5  | 3 → 3 | 3 | 3 / 0 / 0 | 0.40 | **8,443,234 (+0.4 %)** | **4,440,000 (−0.2 %)** | 7 | 480 | 3,840 | **279 h (−0.1 %)** | **1.113 (+0.3 %)** | 131,856 | **10,297 (+0.5 %)** | **2,199 (+0.4 %)** | 2 → 2 | 1 → 1 | ✓ | 17 ms |
| his usual setup of 2026-09-19 (Aydae alo | 3 → 3 | 3 | 3 / 0 / 0 | 0.28 | **11,756,170 (+0.3 %)** | **6,132,900 (−0.1 %)** | 5 | 352 | 3,960 | **375 h (+0.0 %)** | **1.419 (+0.6 %)** | 422,679 | **23,327 (+0.3 %)** | **2,721 (+0.3 %)** | 5 → 5 | 2 → 2 | ✓ | 16 ms |


**Stops**: 61 without the pass, 61 with it; 57 carry a re-typing. **The owner’s rating, stop by stop** (58 matched by name): **54 better, 4 equal, 0 worse**; the worst 0.00 (live account of 2026-09-18 (one hired ty SW). Stops whose campaign damage fell: 0. **2 of 17** use cases read no worse on any of the ten readings. **TotalStack at matched spend**: 47 / 13 → 70 / 13 (dominated / no stop fits). Use cases where a bar criterion breaks with the pass: 0.
...
|---|---:|---:|---:|
| queue, summed | 88,131 h | 85,636 h | -2.83 % |
| speed-ups consumed, first campaign, summed | 88,139 h | 85,644 h | -2.83 % |
| waste in that | 0.01 % | 0.01 % | |
| campaigns the stock pays, summed over stops | 692 | 723 | 4.48 % |
...
The pass as the engine clocks it (`CampaignPlan.retype.ms`): slowest **139 ms** (first-run army, monster tiers 3–5 at 900 dominance (hunters 83 · Bear V 6 — experiment 110’s camp)). Runs its deadline cut: 0.
...
| the 4 000-leadership case of 2026- | SS | swordsman-1 304, spearman-1 298, spearman-2 162, rider-2 106, archer-1 375, rider-3 57, archer-2 201, rider-1 177 | swordsman-1 304, spearman-2 166, spearman-1 292, archer-1 381, rider-1 189, archer-2 203, rider-3 57, rider-2 99 | 5,212,861 → 5,363,321 | 3,820,600 → 3,830,800 | 1.364 → 1.400 | 238 h → 237 h | 2.84 |
...
| 2026-09-17 export, its setup (7 00 | SS | spearman-1 975, spearman-2 531, rider-2 285, rider-1 504, archer-1 1,108, rider-3 151, archer-2 592 | spearman-1 975, spearman-2 531, rider-2 285, rider-1 504, archer-1 1,108, rider-3 151, archer-2 592 | 16,115,314 → 16,350,831 | 8,695,000 → 8,695,700 | 1.853 → 1.880 | 583 h → 583 h | 1.46 |
...
| 2026-09-17 export, 12 000 leadersh | SS | spearman-1 1,216, spearman-2 663, rider-2 356, rider-1 629, archer-1 1,383, rider-3 188, archer-2 739 | spearman-1 1,216, spearman-2 663, rider-2 356, rider-1 629, archer-1 1,383, rider-3 188, archer-2 739 | 21,273,264 → 21,998,092 | 12,129,500 → 12,130,200 | 1.754 → 1.813 | 814 h → 814 h | 3.41 |
...
| live account of 2026-09-18 (one hi | SS | archer-1 2,257, rider-1 903, spearman-2 959, spearman-1 1,690, archer-2 1,158, rider-3 260, rider-2 454 | archer-1 2,257, rider-1 903, spearman-2 959, spearman-1 1,690, archer-2 1,158, rider-2 463, rider-3 256 | 18,256,930 → 18,260,983 | 18,959,900 → 18,610,500 | 0.963 → 0.981 | 1,317 h → 1,310 h | 0.40 |
...
| live account, evening (hunters 83, | SS | archer-1 1,680, rider-1 672, spearman-2 713, spearman-1 1,258, archer-2 862, rider-3 194, rider-2 338 | archer-1 1,680, rider-1 672, spearman-2 713, spearman-1 1,258, archer-2 862, rider-2 346, rider-3 191 | 20,649,596 → 21,949,224 | 12,339,900 → 12,350,700 | 1.673 → 1.777 | 814 h → 815 h | 6.27 |
...
| the owner’s live camp of 2026-09-1 | SS | rider-2 909, rider-3 501 | spearman-1 3,185, rider-3 501 | 8,393,455 → 8,948,744 | 6,773,900 → 6,914,500 | 1.239 → 1.294 | 753 h → 521 h | 6.97 |
...
| the owner’s live camp of 2026-09-1 | MM | rider-3 2,441 | rider-3 2,441 | 20,226,481 → 20,781,770 | 12,194,900 → 12,196,000 | 1.659 → 1.704 | 1,839 h → 1,839 h | 2.74 |
| the owner’s live camp of 2026-09-1 | MX | rider-3 2,441 | rider-3 2,441 | 30,986,506 → 31,541,795 | 12,194,900 → 12,196,000 | 2.541 → 2.586 | 1,839 h → 1,839 h | 1.79 |
...
| his camp of 2026-09-19, the localS | SS | spearman-2 719, rider-3 203, rider-2 354, rider-1 625, archer-2 835 | spearman-1 1,293, rider-2 362, rider-3 200, rider-1 625, archer-2 835 | 7,561,467 → 7,864,909 | 7,313,300 → 7,410,500 | 1.034 → 1.061 | 627 h → 536 h | 4.11 |
...
| his TotalStack profile of 2026-09- | SS | swordsman-1 515, rider-1 160, archer-1 313, spearman-2 171, spearman-1 301, rider-3 46, archer-2 161, rider-2 79 | swordsman-1 515, archer-1 320, rider-1 157, spearman-1 308, spearman-2 168, archer-2 164, rider-3 46, rider-2 79 | 4,919,095 → 4,942,357 | 4,431,600 → 4,440,000 | 1.110 → 1.113 | 279 h → 279 h | 0.43 |
