...
|---|---|---|---|---:|---|---|---|---|---|---|---|---|---|---|---|---|---|---:|
| first-run army, Bear V ×1 (20 000 leader | 1 → 1 | 1 | 1 / 0 / 0 | 1.59 | **18,479,500 (+1.6 %)** | 32,525,600 | 1 | 0 | 0 | **2,524 h (−0.1 %)** | **0.568 (+1.6 %)** | 112,200 | 0 | — | 1 → 3 | 0 → 0 | ✓ | 39 ms |
| first-run army, Bear V ×2 (20 000 leader | 1 → 1 | 1 | 1 / 0 / 0 | 1.58 | **18,703,900 (+1.6 %)** | 32,525,600 | 2 | 160 | 0 | **2,524 h (−0.1 %)** | **0.575 (+1.6 %)** | 168,300 | **116,899 (+1.6 %)** | — | 1 → 3 | 0 → 0 | ✓ | 39 ms |
| first-run army, Bear V ×3 (20 000 leader | 2 → 2 | 2 | 2 / 0 / 0 | 1.55 | **19,040,500 (+1.5 %)** | 32,525,600 | 3 | 0 | 0 | **2,524 h (−0.1 %)** | **0.585 (+1.5 %)** | 224,400 | **39,668 (+1.5 %)** | — | 2 → 8 | 0 → 0 | ✓ | 33 ms |
| first-run army, Bear V ×10 (20 000 leade | 2 → 2 | 2 | 2 / 0 / 0 | 1.40 | **21,290,233 (+1.9 %)** | 32,525,600 | 4 | 3,200 | 0 | **2,524 h (−0.1 %)** | **0.647 (+1.4 %)** | 776,050 | **6,581 (+1.4 %)** | — | 2 → 4 | 0 → 0 | ✓ | 36 ms |
| first-run army, Epic Monster Hunter VI × | 4 → 4 | 4 | 4 / 0 / 0 | 0.98 | **30,140,049 (+1.0 %)** | 32,525,600 | 11 | 736 | 0 | **2,524 h (−0.1 %)** | **0.922 (+1.0 %)** | 423,145 | **30,998 (+1.3 %)** | — | 5 → 7 | 0 → 0 | ✓ | 90 ms |
| first-run army, monster tiers 3–5 at 900 | 5 → 5 | 5 | 5 / 0 / 0 | 0.22 | **103,197,710 (+0.2 %)** | **34,920,400 (+0.0 %)** | 15 | 9,424 | 24,120 | **2,863 h (−0.1 %)** | **2.766 (+0.2 %)** | 597,802 | **9,496 (+0.3 %)** | **3,816 (+0.2 %)** | 0 → 0 | 3 → 3 | ✓ | 186 ms |
| the 4 000-leadership case of 2026-09-15  | 3 → 3 | 2 | 2 / 1 / 0 | 0.00 | **8,985,057 (+5.5 %)** | 3,820,600 | 19 | 736 | 0 | 238 h | **1.476 (+5.4 %)** | 265,255 | **7,254 (+2.4 %)** | — | 6 → 10 | 0 → 0 | ✓ | 43 ms |
| 2026-09-17 export, its setup (7 000 lead | 5 → 5 | 4 | 4 / 1 / 0 | 0.00 | **24,936,555 (+5.8 %)** | 8,695,000 | 26 | 2,112 | 0 | 583 h | **2.216 (+6.7 %)** | 357,360 | **7,252 (+1.6 %)** | — | 6 → 6 | 3 → 3 | ✓ | 39 ms |
| 2026-09-17 export, 12 000 leadership | 4 → 4 | 3 | 3 / 1 / 0 | 0.00 | **34,617,571 (+8.3 %)** | 12,129,500 | 30 | 2,408 | 0 | 814 h | **1.833 (+4.5 %)** | 369,197 | **9,304 (+3.3 %)** | — | 3 → 3 | 2 → 2 | ✓ | 40 ms |
| live account of 2026-09-18 (one hired ty | 4 → 4 | 0 | 0 / 4 / 0 | 0.00 | 29,743,332 | 18,959,900 | 20 | 1,368 | 0 | 1,317 h | 0.963 | 317,110 | 16,063 | — | 9 → 9 | 0 → 0 | ✓ | 8 ms |
...
| the owner’s live camp of 2026-09-18 (arb | 5 → 5 | 4 | 4 / 1 / 0 | 0.00 | **31,541,795 (+1.8 %)** | 6,773,900 | 16 | 1,448 | 0 | **476 h (+0.1 %)** | **2.586 (+1.8 %)** | **257,643 (+10.7 %)** | **6,092 (+6.8 %)** | — | 0 → 0 | 0 → 0 | ✓ | 8 ms |
| his camp of 2026-09-19, the localStorage | 5 → 5 | 3 | 3 / 2 / 0 | 0.00 | 23,589,127 | 7,313,300 | 6 | 392 | 0 | **510 h (−0.1 %)** | 1.808 | 318,189 | **17,713 (+4.6 %)** | — | 2 → 2 | 1 → 1 | ✓ | 41 ms |
| his camp of 2026-09-19, as his message r | 5 → 5 | 4 | 4 / 0 / 0 | 0.75 | **11,587,344 (+0.0 %)** | **7,741,400 (+7.5 %)** | 15 | 1,056 | 0 | **657 h (+13.1 %)** | **1.167 (+9.2 %)** | 258,218 | **7,011 (+0.0 %)** | — | 2 → 2 | 1 → 1 | ✓ | 13 ms |
| his TotalStack profile of 2026-09-19 (5  | 3 → 3 | 2 | 2 / 1 / 0 | 0.00 | **8,443,234 (+0.4 %)** | 4,431,600 | 7 | 480 | 3,840 | 279 h | 1.110 | 131,856 | 10,248 | **2,199 (+0.4 %)** | 2 → 2 | 1 → 1 | ✓ | 24 ms |
| his usual setup of 2026-09-19 (Aydae alo | 3 → 3 | 3 | 3 / 0 / 0 | 0.28 | **11,756,170 (+0.3 %)** | **6,132,900 (−0.1 %)** | 5 | 352 | 3,960 | **375 h (+0.0 %)** | **1.419 (+0.6 %)** | 422,679 | **23,327 (+0.3 %)** | **2,721 (+0.3 %)** | 5 → 5 | 2 → 2 | ✓ | 21 ms |
...
|---|---:|---:|---:|
| queue, summed | 88,131 h | 86,961 h | -1.33 % |
| speed-ups consumed, first campaign, summed | 88,139 h | 86,969 h | -1.33 % |
...
The pass as the engine clocks it (`CampaignPlan.retype.ms`): slowest **186 ms** (first-run army, monster tiers 3–5 at 900 dominance (hunters 83 · Bear V 6 — experiment 110’s camp)). Runs its deadline cut: 0.
