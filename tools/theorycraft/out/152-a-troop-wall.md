# 152 — a single troop wall on the bar

**Today** is the bar as shipped (180ab3d: hired saver + fold to five); **wall** is the same engine with the band allowing a plan on a single troop stack (`bandTroopStacks: 1`). The column headed “fold” below is the wall. Figures are the campaign’s — four marches, worst opening, default recovery; the queue is one training queue’s total over the four marches, speed bonuses on, no speed-up items. In the per-army tables a change is printed as the player reads it: **+** better, **−** worse.
...
|---|---|---|---|---|---|---|---|---:|
| first-run army, Bear V ×1 (20 000 leader | SW | SW | — | — | 1 → 1 | 0 → 0 | — | -34 |
| first-run army, Bear V ×2 (20 000 leader | SW | SW | — | — | 1 → 1 | 0 → 0 | — | -5 |
| first-run army, Bear V ×3 (20 000 leader | SW · AI | SW · AI | — | — | 2 → 2 | 0 → 0 | — | -0 |
| first-run army, Bear V ×10 (20 000 leade | SW · AI | SW · AI | — | — | 2 → 2 | 0 → 0 | — | -0 |
| first-run army, Epic Monster Hunter VI × | HS · SW · MX · AI | HS · SW · MX · AI | — | — | 5 → 5 | 0 → 0 | — | -23 |
| first-run army, monster tiers 3–5 at 900 | HS · SW · MM · MX · AI | HS · SW · MM · MX · AI | — | — | 0 → 0 | 3 → 3 | — | -376 |
| the 4 000-leadership case of 2026-09-15  | SS · SW · AI | SS · SW · AI | — | — | 6 → 6 | 0 → 0 | — | -51 |
| 2026-09-17 export, its setup (7 000 lead | HS · SS · SW · MX · AI | HS · SS · SW · MX · AI | — | — | 6 → 6 | 3 → 3 | — | -46 |
| 2026-09-17 export, 12 000 leadership | HS · SS · SW · MX | HS · SS · SW · MX | — | — | 3 → 3 | 2 → 2 | — | 21 |
| live account of 2026-09-18 (one hired ty | SS · SW · MX · AI | SS · SW · MX · AI | — | — | 9 → 9 | 0 → 0 | — | -2 |
| live account, evening (hunters 83, legio | HS · SS · SW · MX · AI | HS · SS · SW · MX · AI | — | — | 1 → 1 | 0 → 0 | — | -3 |
| Aydae alone, 4 975 (one captain, four hi | HS · SW · MX · AI | HS · SW · MX · AI | — | — | 0 → 0 | 0 → 0 | — | -14 |
| the owner’s live camp of 2026-09-18 (arb | HS · SW · MM · MX · AI | HS · SS · SW · MM · MX | most damage, dmg a silver | least silver, dmg a merc | 0 → 0 | 0 → 0 | more-mercs fields 1 troop stack; steady-max fields 1 troop stack | 35 |
| his camp of 2026-09-19, the localStorage | HS · SS · SW · MM · MX | HS · SS · SW · MM · MX | most damage, dmg a silver | — | 2 → 2 | 1 → 1 | steady-max fields 1 troop stack | 3 |
| his camp of 2026-09-19, as his message r | HS · SW · MM · MX · AI | HS · SW · MM · MX · AI | — | — | 2 → 2 | 1 → 1 | — | 1 |
| his TotalStack profile of 2026-09-19 (5  | SS · SW · MX | SS · SW · MX | — | — | 2 → 2 | 1 → 1 | — | 14 |
| his usual setup of 2026-09-19 (Aydae alo | HS · SW · MX | HS · SW · MX | — | — | 5 → 5 | 2 → 2 | — | 72 |


**TotalStack rows**: today 47 beaten / 13 no stop fits; fold 47 / 13. **Armies where the fold reads worse on some reading:** 1. **Armies where the folded bar breaks a criterion:** 2. **The most the fold added to one plan:** 72 ms.

| reading | armies better | armies worse |
|---|---:|---:|
| most damage | 2 | 0 |
| least silver | 0 | 1 |
| fewest hired burned | 0 | 0 |
| least gold | 0 | 0 |
| fewest coins | 0 | 0 |
| shortest queue | 0 | 0 |
| dmg a silver | 2 | 0 |
...
| bar | most damage | least silver | fewest hired burned | least gold | fewest coins | shortest queue | dmg a silver | dmg a merc | dmg a gold | dmg a coin | TS beaten | TS no fit |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| today | 31,963,845 | 12,129,500 | 30 | 2,408 | 0 | 814 h | 1.754 | 369,197 | 9,003 | — | 3 | 2 |
| fold | 31,963,845 | 12,129,500 | 30 | 2,408 | 0 | 814 h | 1.754 | 369,197 | 9,003 | — | 3 | 2 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| HS | 3 | 2,010,108 | 8,260,768 | 7,241,900 | 16 | 1,448 | 0 | 477 h | 1.141 | 232,812 | 5,705 | — |
| SS | 9 | 2,054,337 | 8,393,455 | 6,773,900 | 34 | 5,480 | 0 | 753 h | 1.239 | 159,825 | 1,532 | — |
| SW | 15 | 4,358,805 | 15,306,859 | 9,849,200 | 52 | 6,344 | 0 | 1,024 h | 1.554 | 200,697 | 2,413 | — |
| MM | 43 | 5,998,679 | 20,226,481 | 12,194,900 | 136 | 13,760 | 0 | 1,839 h | 1.659 | 141,322 | 1,470 | — |
| MX | 67 | 9,585,354 | 30,986,506 | 12,194,900 | 208 | 28,736 | 0 | 1,839 h | 2.541 | 144,134 | 1,078 | — |

| bar | most damage | least silver | fewest hired burned | least gold | fewest coins | shortest queue | dmg a silver | dmg a merc | dmg a gold | dmg a coin | TS beaten | TS no fit |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| today | 15,306,859 | 6,653,700 | 16 | 1,448 | 0 | 477 h | 1.638 | 233,912 | 5,705 | — | 0 | 0 |
| fold | **30,986,506 (+102.4 %)** | **6,773,900 (−1.8 %)** | 16 | 1,448 | 0 | 477 h | **2.541 (+55.1 %)** | **232,812 (−0.5 %)** | 5,705 | — | 0 | 0 |
...
| SS | 3 | 1,882,911 | 7,561,467 | 7,313,300 | 12 | 848 | 0 | 627 h | 1.034 | 318,189 | 8,917 | — |
| SW | 4 | 2,385,168 | 9,068,238 | 8,746,700 | 15 | 1,016 | 0 | 760 h | 1.037 | 306,324 | 8,925 | — |
| MM | 18 | 3,976,648 | 13,842,678 | 10,476,500 | 57 | 3,944 | 0 | 1,234 h | 1.321 | 164,062 | 3,510 | — |
| MX | 38 | 6,050,983 | 23,589,127 | 13,043,800 | 148 | 10,480 | 0 | 2,174 h | 1.808 | 159,386 | 2,251 | — |

| bar | most damage | least silver | fewest hired burned | least gold | fewest coins | shortest queue | dmg a silver | dmg a merc | dmg a gold | dmg a coin | TS beaten | TS no fit |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| today | 13,842,678 | 7,313,300 | 6 | 392 | 0 | 510 h | 1.321 | 318,189 | 16,934 | — | 2 | 1 |
| fold | **23,589,127 (+70.4 %)** | 7,313,300 | 6 | 392 | 0 | 510 h | **1.808 (+36.9 %)** | 318,189 | 16,934 | — | 2 | 1 |
