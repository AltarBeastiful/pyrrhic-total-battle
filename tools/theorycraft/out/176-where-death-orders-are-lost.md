# 176 — where the death orders are lost

Every benchmark army planned at HEAD, `budgetMs` off, the plan kernel set, with the test-only recorder `planTrace` (`src/engine/plan-trace.ts`, off by default) on the re-typing pipeline. Gain = 175’s exhaustive best in the re-typing space against the shipped march (`rate(·, ·, markerRates)`); engine = `retypeMarch` run on the shipped march (tier candidate on, no deadline), i.e. **the rating that would be kept** if the pipeline handed it that march and kept the answer. A march the engine reaches (within 5e-4) is classified by the trace; one it does not is the search’s gap. Every figure measured.

**55** of 129 distinct marches leave more than 0.01 (Σ +94.008); the engine reaches **37** of them (Σ +72.705).

Each march is classified by what, in the pipeline, loses the rating `retypeMarch` finds on it; the search’s own shortfall (175 gain − what `retypeMarch` finds) is its own column, so the two add up to the gain. “Silver-guarded” is the exhaustive best with the march’s silver not rising (step 2’s rule, per march).

## A. By cause

| cause | marches | Σ 175 gain | Σ kept by `retypeMarch` | Σ search gap | Σ silver-guarded best |
|---|---:|---:|---:|---:|---:|
| a — row-level silver-saver guard | 13 | +60.342 | +59.331 | +1.012 | +55.015 |
| e — own-ladder finale, made after the pass | 5 | +28.652 | +28.652 | 0 | +28.652 |
| search — handed over, `retypeMarch` finds nothing | 8 | +2.620 | 0 | +2.620 | +2.620 |
| other — re-typed march is not a fixed point | 29 | +2.394 | +0.918 | +1.563 | +1.967 |
...
|---|---|---|---|---:|---|---|---:|---:|
| the owner’s live camp of 2026-09-18 (arbales | SS | SS finale | climb | **+24.878** | a: row-level silver-saver guard | found +24.878, row handed back | +24.878 | +24.858 |
| his camp of 2026-09-19, the localStorage dum | SS | SS finale | climb | **+15.886** | a: row-level silver-saver guard | found +15.656, row handed back; the climb also stops short | +15.656 | +14.717 |
| his camp of 2026-09-19, as his message reads | MX | MX finale | exhaustive | **+12.185** | e: own-ladder finale, made after the pass | never handed to `retypeOne` | +12.185 | +12.185 |
| 2026-09-17 export, 12 000 leadership | SS | SS finale | climb | **+9.132** | a: row-level silver-saver guard | found +9.132, row handed back | +9.132 | +8.542 |
| his camp of 2026-09-19, as his message reads | HS/SW | HS finale, SW finale | climb | **+7.716** | e: own-ladder finale, made after the pass | never handed to `retypeOne` | +7.716 | +7.716 |
| the 4 000-leadership case of 2026-09-15 (Tot | SS | SS finale | climb | **+6.487** | a: row-level silver-saver guard | found +6.487, row handed back | +6.487 | +3.782 |
| live account, evening (hunters 83, legionari | SS | SS finale | climb | **+5.097** | e: own-ladder finale, made after the pass | never handed to `retypeOne` | +5.097 | +5.097 |
| 2026-09-17 export, its setup (7 000 leadersh | SS | SS finale | climb | **+3.623** | e: own-ladder finale, made after the pass | never handed to `retypeOne` | +3.623 | +3.623 |
| his TotalStack profile of 2026-09-19 (5 225  | SS | SS finale | climb | **+0.936** | a: row-level silver-saver guard | found +0.936, row handed back | +0.936 | +0.896 |
| live account of 2026-09-18 (one hired type,  | SS | SS finale | climb | **+0.917** | a: row-level silver-saver guard | found +0.917, row handed back | +0.917 | +0.917 |
| the 4 000-leadership case of 2026-09-15 (Tot | SS | SS repeat | climb | **+0.585** | a: row-level silver-saver guard | found +0.585, row handed back | +0.585 | 0 |
| his camp of 2026-09-19, the localStorage dum | HS | HS repeat | climb | **+0.549** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +0.087); a second climb gains; the climb also stops short | +0.160 | +0.549 |
| the owner’s live camp of 2026-09-18 (arbales | HS | HS repeat | climb | **+0.435** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +0.051); a second climb gains; the climb also stops short | +0.175 | +0.435 |
| the owner’s live camp of 2026-09-18 (arbales | SS | SS repeat | exhaustive | **+0.356** | a: row-level silver-saver guard | found +0.356, row handed back | +0.356 | +0.313 |
| live account of 2026-09-18 (one hired type,  | AI | AI sequence 4 | climb | **+0.353** | search: handed over, `retypeMarch` finds nothing | the climb’s own gap | 0 | +0.353 |
| live account of 2026-09-18 (one hired type,  | SW | SW repeat | climb | **+0.351** | search: handed over, `retypeMarch` finds nothing | the climb’s own gap | 0 | +0.351 |
| his camp of 2026-09-19, as his message reads | SS | SS repeat | climb | **+0.346** | a: row-level silver-saver guard | found +0.072, row handed back; the climb also stops short | +0.072 | +0.346 |
| live account of 2026-09-18 (one hired type,  | AI | AI sequence 3 | climb | **+0.344** | search: handed over, `retypeMarch` finds nothing | the climb’s own gap | 0 | +0.344 |
| live account of 2026-09-18 (one hired type,  | MX | MX repeat | climb | **+0.342** | search: handed over, `retypeMarch` finds nothing | the climb’s own gap | 0 | +0.342 |
| live account of 2026-09-18 (one hired type,  | MX | MX finale | climb | **+0.339** | search: handed over, `retypeMarch` finds nothing | the climb’s own gap | 0 | +0.339 |
| live account of 2026-09-18 (one hired type,  | AI | AI sequence 2 | climb | **+0.335** | search: handed over, `retypeMarch` finds nothing | the climb’s own gap | 0 | +0.335 |
| live account of 2026-09-18 (one hired type,  | AI | AI sequence 1 | climb | **+0.325** | search: handed over, `retypeMarch` finds nothing | the climb’s own gap | 0 | +0.325 |
| live account, evening (hunters 83, legionari | HS | HS repeat | climb | **+0.323** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +0.001); a second climb gains; the climb also stops short | +0.007 | +0.323 |
| live account of 2026-09-18 (one hired type,  | SS | SS repeat | climb | **+0.321** | a: row-level silver-saver guard | found +0.014, row handed back; the climb also stops short | +0.014 | +0.321 |
| live account, evening (hunters 83, legionari | SW | SW repeat | climb | **+0.232** | search: handed over, `retypeMarch` finds nothing | the climb’s own gap | 0 | +0.232 |
| live account, evening (hunters 83, legionari | SS | SS repeat | climb | **+0.225** | a: row-level silver-saver guard | found +0.025, row handed back; the climb also stops short | +0.025 | +0.225 |
| live account, evening (hunters 83, legionari | MX | MX finale | climb | **+0.204** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +19.890); a second climb gains; the climb also stops short | 0 | +0.202 |
| live account, evening (hunters 83, legionari | SW | SW finale | climb | **+0.201** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +19.544); a second climb gains; the climb also stops short | 0 | +0.199 |
| live account, evening (hunters 83, legionari | HS | HS finale | climb | **+0.192** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +18.574); a second climb gains; the climb also stops short | 0 | +0.190 |
| his camp of 2026-09-19, the localStorage dum | SS | SS repeat | exhaustive | **+0.167** | a: row-level silver-saver guard | found +0.167, row handed back | +0.167 | 0 |
| his TotalStack profile of 2026-09-19 (5 225  | SS | SS repeat | climb | **+0.104** | a: row-level silver-saver guard | found +0.104, row handed back | +0.104 | +0.096 |
| Aydae alone, 4 975 (one captain, four hired  | HS | HS repeat | climb | **+0.054** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +0.043); a second climb gains | +0.054 | +0.054 |
| his camp of 2026-09-19, as his message reads | AI | AI sequence 4 | exhaustive | **+0.036** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.896); a second climb gains | +0.067 | 0 |
| his camp of 2026-09-19, as his message reads | AI | AI sequence 3 | exhaustive | **+0.033** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.892); a second climb gains | +0.061 | 0 |
| his camp of 2026-09-19, as his message reads | MX | MX repeat | exhaustive | **+0.032** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.891); a second climb gains | +0.060 | 0 |
| Aydae alone, 4 975 (one captain, four hired  | MX | MX finale | climb | **+0.031** | e: own-ladder finale, made after the pass | never handed to `retypeOne` | +0.031 | +0.031 |
| first-run army, Bear V ×10 (20 000 leadershi | AI | AI sequence 2 | climb | **+0.026** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +0.902); a second climb gains | +0.026 | +0.001 |
| his camp of 2026-09-19, as his message reads | HS | HS repeat | climb | **+0.023** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +0.930); a second climb gains | +0.023 | +0.010 |
| first-run army, Bear V ×10 (20 000 leadershi | AI | AI sequence 4 | climb | **+0.019** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.497); a second climb gains | +0.019 | +0.001 |
| first-run army, Bear V ×1 (20 000 leadership | SW | SW tail | climb | **+0.019** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.605); a second climb gains | +0.019 | 0 |
| first-run army, Bear V ×2 (20 000 leadership | SW | SW tail | climb | **+0.019** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.605); a second climb gains | +0.019 | 0 |
| first-run army, Bear V ×3 (20 000 leadership | SW/AI | SW tail, AI sequence 4 | climb | **+0.019** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.605); a second climb gains | +0.019 | 0 |
| first-run army, Bear V ×10 (20 000 leadershi | AI | AI sequence 3 | climb | **+0.018** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.465); a second climb gains | +0.018 | +0.001 |
| first-run army, Bear V ×1 (20 000 leadership | SW | SW repeat | climb | **+0.018** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.566); a second climb gains | +0.018 | 0 |
| first-run army, Bear V ×2 (20 000 leadership | SW | SW finale | climb | **+0.018** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.566); a second climb gains | +0.018 | 0 |
| first-run army, Bear V ×3 (20 000 leadership | SW/AI | SW repeat, AI sequence 3 | climb | **+0.018** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.566); a second climb gains | +0.018 | 0 |
| first-run army, Bear V ×2 (20 000 leadership | SW | SW repeat | climb | **+0.018** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.529); a second climb gains | +0.018 | 0 |
| first-run army, Bear V ×3 (20 000 leadership | AI | AI sequence 2 | climb | **+0.018** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.529); a second climb gains | +0.018 | 0 |
| his usual setup of 2026-09-19 (Aydae alone,  | HS | HS repeat | climb | **+0.017** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +0.160); a second climb gains | +0.017 | 0 |
| first-run army, Bear V ×3 (20 000 leadership | AI | AI sequence 1 | climb | **+0.017** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.493); a second climb gains | +0.017 | 0 |
| first-run army, Epic Monster Hunter VI ×83 ( | HS | HS repeat | climb | **+0.017** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.465); a second climb gains | +0.017 | 0 |
| first-run army, Bear V ×10 (20 000 leadershi | SW | SW repeat, SW finale | climb | **+0.016** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.396); a second climb gains | +0.016 | 0 |
| 2026-09-17 export, its setup (7 000 leadersh | AI | AI sequence 2 | exhaustive | **+0.013** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.615); a second climb gains | +0.013 | 0 |
| first-run army, Epic Monster Hunter VI ×83 ( | AI | AI sequence 2 | climb | **+0.012** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +1.016); a second climb gains | +0.012 | +0.001 |
| first-run army, Epic Monster Hunter VI ×83 ( | AI | AI sequence 1 | climb | **+0.011** | other: re-typed march is not a fixed point | the pass's own output (from a march rated +0.966); a second climb gains | +0.011 | +0.001 |

## The TypeScript path

| army | trace events | plan | trace | kernel ms | TS ms |
|---|---:|---|---|---:|---:|
| the 4 000-leadership case of 2026-09-15 (Tot | 15 | same | same | 99 | 618 |
| live account of 2026-09-18 (one hired type,  | 23 | same | same | 14 | 82 |
| the owner’s live camp of 2026-09-18 (arbales | 20 | same | same | 80 | 439 |
| his camp of 2026-09-19, the localStorage dum | 20 | same | same | 23 | 94 |
| his camp of 2026-09-19, as his message reads | 33 | same | same | 21 | 63 |

## B. The HEAD baseline (§2)

18 armies (0 refused), 63 stops, 145 stop-march use cases. Machine-readable: `tools/theorycraft/out/176-baseline.json` (read it with `loadJson` and diff with `compareReports` in `tools/theorycraft/plan-report.ts`). TotalStack at matched spend (172's reading): **70 dominated / 13 no stop fits** of 112 rows; 162's rows no stop beats on damage or rating: **2**. Bar criteria broken: none.
...
| stop | march | × | margin | sustain | worst | best | silver | gold | hired | coins | queue | dmg/silver | dmg/gold | dmg/hired | dmg/coin | counts |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **SS** | campaign | 4 | 1.122 | 6 | 5,212,861 | 5,355,295 | 3,820,600 | 736 | 19 | 0 | 237.8 h | 1.364 | 7,082.7 | 189,918 | ∞ |  |
...
| SS | finale | 1 | 1.122 | 6 | 1,991,647 | 2,046,073 | 1,520,800 | 304 | 7 | 0 | 95.0 h | 1.310 | 6,551.5 | 209,499 | ∞ | swordsman-1 564, archer-1 752, spearman-1 562, rider-1 375, archer-2 416, spearman-2 310, rider-2 207, rider-3 116, legionary-6 13, arbalester-6 12, epic-monster-hunter-6 11, chariot-6 5 |
...
**Ten readings**: most damage 8,985,057 · least silver 3,820,600 · fewest hired lost 19.000 · least gold 736 · fewest coins 0.000 · shortest queue 237.8 h · dmg a silver 1.476 · dmg a merc 265,255 · dmg a gold 7,254 · dmg a coin 0.000.
**Bar criteria**: order ✓ · noStopBeaten ✓ · shelter ✓ · sustain ✓ · atMostFive ✓ · sweetSpot ✓ · s58b ✓.
**TotalStack** (172's reading, matched spend): 10 dominated / 0 no stop fits, of 10 rows; 162's rows no stop beats on damage or rating: 0.

### 2026-09-17 export, its setup (7 000 leadership)

| stop | march | × | margin | sustain | worst | best | silver | gold | hired | coins | queue | dmg/silver | dmg/gold | dmg/hired | dmg/coin | counts |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **HS** | campaign | 4 | 1.000 | 11 | 15,315,363 | 16,042,391 | 10,187,600 | 2,112 | 26 | 0 | 683.2 h | 1.503 | 7,251.6 | 355,600 | ∞ |  |
...
| HS | finale | 1 | 1.000 | 11 | 5,703,414 | 5,891,477 | 2,740,100 | 1,032 | 14 | 0 | 184.9 h | 2.081 | 5,526.6 | 310,959 | ∞ | legionary-6 33, epic-monster-hunter-6 38, arbalester-6 40, chariot-6 17, spearman-1 1,275, spearman-2 708, archer-1 1,562, rider-1 695, rider-2 386, archer-2 862, rider-3 215 |
...
**Ten readings**: most damage 24,945,884 · least silver 8,670,400 · fewest hired lost 26.000 · least gold 2,112 · fewest coins 0.000 · shortest queue 576.8 h · dmg a silver 2.217 · dmg a merc 357,360 · dmg a gold 7,252 · dmg a coin 0.000.
**Bar criteria**: order ✓ · noStopBeaten ✓ · shelter ✓ · sustain ✓ · atMostFive ✓ · sweetSpot ✓ · s58b ✓.
**TotalStack** (172's reading, matched spend): 6 dominated / 3 no stop fits, of 9 rows; 162's rows no stop beats on damage or rating: 0. **Re-chosen**: S-94 all-in rebuilt; fold HS/SS/SW/MM/MX/AI → HS/SS/SW/MX/AI; SS own-ladder finale.
...
| **SS** | campaign | 4 | 1.004 | 5 | 21,273,264 | 22,153,735 | 12,129,500 | 3,056 | 48 | 0 | 813.9 h | 1.754 | 6,961.1 | 297,347 | ∞ |  |
...
| SS | finale | 1 | 1.004 | 5 | 7,932,984 | 8,275,375 | 4,697,600 | 1,208 | 18 | 0 | 317.0 h | 1.689 | 6,567.0 | 313,298 | ∞ | archer-1 2,687, spearman-1 2,179, rider-1 1,193, archer-2 1,485, spearman-2 1,205, rider-2 659, rider-3 370, epic-monster-hunter-6 66, legionary-6 36, arbalester-6 41, chariot-6 14 |
...
**Ten readings**: most damage 34,617,571 · least silver 12,129,500 · fewest hired lost 30.000 · least gold 2,408 · fewest coins 0.000 · shortest queue 813.9 h · dmg a silver 1.833 · dmg a merc 369,197 · dmg a gold 9,304 · dmg a coin 0.000.
**Bar criteria**: order ✓ · noStopBeaten ✓ · shelter ✓ · sustain ✓ · atMostFive ✓ · sweetSpot ✓ · s58b ✓.
**TotalStack** (172's reading, matched spend): 3 dominated / 2 no stop fits, of 9 rows; 162's rows no stop beats on damage or rating: 0. **Re-chosen**: S-94 all-in dropped; fold took band row(s) as SS.

### live account of 2026-09-18 (one hired type, 20 000 leadership)

| stop | march | × | margin | sustain | worst | best | silver | gold | hired | coins | queue | dmg/silver | dmg/gold | dmg/hired | dmg/coin | counts |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **SS** | campaign | 4 | 1.248 | 11 | 18,256,930 | 18,256,930 | 18,959,900 | 1,368 | 20 | 0 | 1,317.1 h | 0.963 | 13,345.7 | 309,021 | ∞ |  |
...
| SS | finale | 1 | 1.873 | 11 | 7,172,638 | 7,172,638 | 8,152,700 | 504 | 8 | 0 | 609.5 h | 0.880 | 14,231.4 | 287,179 | ∞ | archer-1 5,892, rider-2 1,310, spearman-2 2,503, rider-1 2,266, archer-2 3,024, rider-3 680, epic-monster-hunter-6 71 |
...
| **MX** | campaign | 4 | 1.562 | 3 | 28,727,202 | 28,727,202 | 30,179,700 | 1,904 | 28 | 0 | 1,976.9 h | 0.952 | 15,087.8 | 307,403 | ∞ |  |
...
| MX | finale | 1 | 1.562 | 3 | 6,662,388 | 6,662,388 | 6,983,400 | 440 | 7 | 0 | 457.5 h | 0.954 | 15,141.8 | 286,601 | ∞ | archer-1 4,373, rider-1 1,750, spearman-2 1,858, spearman-1 3,275, archer-2 2,244, rider-3 505, rider-2 881, epic-monster-hunter-6 62 |
...
**Ten readings**: most damage 29,743,332 · least silver 18,959,900 · fewest hired lost 20.000 · least gold 1,368 · fewest coins 0.000 · shortest queue 1,317.1 h · dmg a silver 0.963 · dmg a merc 323,582 · dmg a gold 16,426 · dmg a coin 0.000.
**Bar criteria**: order ✓ · noStopBeaten ✓ · shelter ✓ · sustain ✓ · atMostFive ✓ · sweetSpot ✓ · s58b ✓.
**TotalStack** (172's reading, matched spend): 9 dominated / 0 no stop fits, of 9 rows; 162's rows no stop beats on damage or rating: 0. **Re-chosen**: fold HS/SS/SW/MX/AI → SS/SW/MX/AI.

### live account, evening (hunters 83, legionaries unlimited, chariots 10, arbalesters 60, 11 000)

| stop | march | × | margin | sustain | worst | best | silver | gold | hired | coins | queue | dmg/silver | dmg/gold | dmg/hired | dmg/coin | counts |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **HS** | campaign | 4 | 1.016 | 3 | 20,575,534 | 20,575,534 | 15,338,400 | 2,296 | 32 | 0 | 1,013.5 h | 1.341 | 8,961.5 | 332,927 | ∞ |  |
...
| HS | finale | 1 | 1.016 | 3 | 8,548,204 | 8,548,204 | 4,296,000 | 1,312 | 20 | 0 | 287.6 h | 1.990 | 6,515.4 | 299,405 | ∞ | epic-monster-hunter-6 62, legionary-6 52, arbalester-6 57, chariot-6 7, archer-1 2,560, spearman-2 1,130, spearman-1 2,025, rider-2 578, rider-1 1,037, archer-2 1,409, rider-3 322 |
| **SS** | campaign | 4 | 1.001 | 7 | 21,392,382 | 21,720,231 | 12,306,900 | 3,032 | 48 | 0 | 805.8 h | 1.738 | 7,055.5 | 289,672 | ∞ |  |
...
| SS | finale | 1 | 1.001 | 7 | 7,713,006 | 8,040,855 | 4,261,800 | 1,232 | 18 | 0 | 278.8 h | 1.810 | 6,260.6 | 310,458 | ∞ | spearman-1 2,122, archer-1 2,619, spearman-2 1,134, rider-1 1,027, archer-2 1,371, rider-2 548, rider-3 302, arbalester-6 51, chariot-6 7, epic-monster-hunter-6 59, legionary-6 49 |
| **SW** | campaign | 4 | 1.016 | 5 | 29,479,912 | 29,479,912 | 17,073,600 | 4,056 | 61 | 0 | 1,124.6 h | 1.727 | 7,268.2 | 301,665 | ∞ |  |
...
| SW | finale | 1 | 1.016 | 5 | 8,190,643 | 8,190,643 | 4,296,000 | 1,248 | 19 | 0 | 287.6 h | 1.907 | 6,563.0 | 296,344 | ∞ | epic-monster-hunter-6 62, legionary-6 52, arbalester-6 48, chariot-6 7, archer-1 2,560, spearman-2 1,130, spearman-1 2,025, rider-2 578, rider-1 1,037, archer-2 1,409, rider-3 322 |
...
**Ten readings**: most damage 34,784,291 · least silver 12,306,900 · fewest hired lost 32.000 · least gold 2,296 · fewest coins 0.000 · shortest queue 805.8 h · dmg a silver 1.988 · dmg a merc 332,927 · dmg a gold 8,961 · dmg a coin 0.000.
**Bar criteria**: order ✓ · noStopBeaten ✓ · shelter ✓ · sustain ✓ · atMostFive ✓ · sweetSpot ✓ · s58b ✓.
**TotalStack** (172's reading, matched spend): 6 dominated / 0 no stop fits, of 9 rows; 162's rows no stop beats on damage or rating: 0. **Re-chosen**: S-94 all-in rebuilt; fold HS/SS/SW/MM/MX/AI → HS/SS/SW/MX/AI; SS own-ladder finale.
...
| **MX** | campaign | 4 | 1.013 | 3 | 18,213,822 | 19,161,952 | 8,666,100 | 4,360 | 61 | 0 | 748.8 h | 2.102 | 4,177.5 | 235,327 | ∞ |  |
...
| MX | finale | 1 | 1.013 | 3 | 3,891,450 | 4,052,395 | 2,054,700 | 736 | 10 | 0 | 157.2 h | 1.894 | 5,287.3 | 282,703 | ∞ | spearman-2 724, rider-1 639, archer-1 1,254, rider-2 341, archer-2 669, rider-3 184, arbalester-6 30, chariot-6 7, epic-monster-hunter-6 29, legionary-6 30 |
...
| **SS** | campaign | 4 | 1.004 | 60 | 8,393,455 | 10,303,485 | 6,773,900 | 5,480 | 34 | 0 | 753.4 h | 1.239 | 1,531.7 | 159,825 | ∞ |  |
| SS | repeat | 3 | 1.249 | 60 | 2,054,337 | 2,640,097 | 1,610,400 | 1,648 | 9 | 0 | 207.8 h | 1.276 | 1,246.6 | 155,938 | ∞ | rider-2 909, rider-3 501, arbalester-6 66, bear-5 8, legionary-6 8 |
| SS | finale | 1 | 1.004 | 60 | 2,230,444 | 2,383,194 | 1,942,700 | 536 | 7 | 0 | 130.0 h | 1.148 | 4,161.3 | 174,820 | ∞ | archer-1 1,158, spearman-1 918, rider-1 470, archer-2 639, spearman-2 508, rider-2 260, rider-3 146, legionary-6 23, bear-5 2, arbalester-6 30 |
| **SW** | campaign | 4 | 1.004 | 52 | 15,862,148 | 16,004,443 | 9,850,300 | 6,344 | 52 | 0 | 1,024.6 h | 1.610 | 2,500.3 | 208,337 | ∞ |  |
...
| SW | finale | 1 | 1.004 | 52 | 2,785,733 | 2,928,028 | 1,943,800 | 536 | 7 | 0 | 130.3 h | 1.433 | 5,197.3 | 231,576 | ∞ | arbalester-6 30, legionary-6 23, bear-5 2, spearman-1 921, spearman-2 511, rider-2 262, rider-1 470, archer-2 639, archer-1 1,147, rider-3 146 |
...
**Ten readings**: most damage 49,190,513 · least silver 6,773,900 · fewest hired lost 16.000 · least gold 1,448 · fewest coins 0.000 · shortest queue 476.3 h · dmg a silver 3.532 · dmg a merc 257,643 · dmg a gold 6,092 · dmg a coin 0.000.
**Bar criteria**: order ✓ · noStopBeaten ✓ · shelter ✓ · sustain ✓ · atMostFive ✓ · sweetSpot ✓ · s58b ✓.
**TotalStack** (172's reading, matched spend): 0 dominated / 0 no stop fits, of 3 rows; 162's rows no stop beats on damage or rating: 2. **Re-chosen**: fold took band row(s) as SS; fold HS/SW/MM/MX → HS/SS/SW/MM/MX; MM own-ladder finale; MX own-ladder finale.
...
| **SS** | campaign | 4 | 1.020 | 141 | 7,561,467 | 8,352,905 | 7,313,300 | 848 | 12 | 0 | 627.0 h | 1.034 | 8,916.8 | 318,189 | ∞ |  |
...
| SS | finale | 1 | 1.020 | 141 | 1,912,734 | 2,065,484 | 1,942,700 | 200 | 3 | 0 | 130.0 h | 0.985 | 9,563.7 | 302,010 | ∞ | archer-1 1,158, spearman-1 918, rider-1 470, archer-2 639, spearman-2 508, rider-2 260, rider-3 146, epic-monster-hunter-6 28 |
...
| **MM** | campaign | 4 | 1.005 | 16 | 14,142,349 | 16,899,631 | 10,354,100 | 3,944 | 57 | 0 | 1,221.7 h | 1.366 | 3,585.8 | 164,062 | ∞ |  |
...
| MM | finale | 1 | 1.020 | 16 | 2,212,405 | 2,212,405 | 1,943,300 | 200 | 3 | 0 | 130.3 h | 1.138 | 11,062.0 | 302,010 | ∞ | epic-monster-hunter-6 28, archer-2 644, spearman-1 918, rider-1 470, spearman-2 509, archer-1 1,150, rider-2 260, rider-3 146 |
...
**Ten readings**: most damage 23,589,127 · least silver 7,313,300 · fewest hired lost 6.000 · least gold 392 · fewest coins 0.000 · shortest queue 510.3 h · dmg a silver 1.808 · dmg a merc 318,189 · dmg a gold 17,713 · dmg a coin 0.000.
**Bar criteria**: order ✓ · noStopBeaten ✓ · shelter ✓ · sustain ✓ · atMostFive ✓ · sweetSpot ✓ · s58b ✓.
**TotalStack** (172's reading, matched spend): 2 dominated / 1 no stop fits, of 3 rows; 162's rows no stop beats on damage or rating: 0.

### his camp of 2026-09-19, as his message reads it (5 100 / 2 200, hunters 120)

| stop | march | × | margin | sustain | worst | best | silver | gold | hired | coins | queue | dmg/silver | dmg/gold | dmg/hired | dmg/coin | counts |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **HS** | campaign | 4 | 1.014 | 111 | 6,580,946 | 7,262,756 | 7,681,400 | 408 | 6 | 0 | 570.2 h | 0.857 | 16,129.8 | 307,403 | ∞ |  |
...
| HS | finale | 1 | 1.014 | 111 | 2,040,677 | 2,192,705 | 1,976,000 | 192 | 3 | 0 | 129.3 h | 1.033 | 10,628.5 | 291,224 | ∞ | spearman-1 984, archer-1 1,214, spearman-2 526, rider-1 476, archer-2 636, rider-2 254, rider-3 140, epic-monster-hunter-6 27 |
...
| **SW** | campaign | 4 | 1.002 | 15 | 10,462,502 | 11,411,336 | 8,940,500 | 1,272 | 18 | 0 | 770.4 h | 1.170 | 8,225.2 | 318,189 | ∞ |  |
...
| SW | finale | 1 | 1.014 | 15 | 2,040,677 | 2,192,705 | 1,976,000 | 192 | 3 | 0 | 129.3 h | 1.033 | 10,628.5 | 291,224 | ∞ | spearman-1 984, archer-1 1,214, spearman-2 526, rider-1 476, archer-2 636, rider-2 254, rider-3 140, epic-monster-hunter-6 27 |
| **MX** | campaign | 4 | 1.002 | 3 | 11,058,844 | 12,919,833 | 9,897,900 | 2,504 | 35 | 0 | 1,113.4 h | 1.117 | 4,416.5 | 183,055 | ∞ |  |
...
| MX | finale | 1 | 1.002 | 3 | 2,432,869 | 2,706,465 | 2,313,600 | 344 | 5 | 0 | 211.1 h | 1.052 | 7,072.3 | 310,639 | ∞ | spearman-2 924, rider-1 837, archer-2 1,116, rider-2 447, rider-3 246, epic-monster-hunter-6 48 |
...
**Ten readings**: most damage 11,589,922 · least silver 7,201,600 · fewest hired lost 6.000 · least gold 408 · fewest coins 0.000 · shortest queue 473.4 h · dmg a silver 1.170 · dmg a merc 323,582 · dmg a gold 16,130 · dmg a coin 0.000.
**Bar criteria**: order ✓ · noStopBeaten ✓ · shelter ✓ · sustain ✓ · atMostFive ✓ · sweetSpot ✓ · s58b ✓.
...
| stop | march | × | margin | sustain | worst | best | silver | gold | hired | coins | queue | dmg/silver | dmg/gold | dmg/hired | dmg/coin | counts |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **SS** | campaign | 4 | 1.013 | 71 | 4,919,095 | 5,091,912 | 4,431,600 | 480 | 7 | 3,840 | 278.7 h | 1.110 | 10,248.1 | 131,856 | 1,281.0 |  |
...
| SS | finale | 1 | 1.013 | 71 | 1,918,492 | 1,996,290 | 1,997,700 | 264 | 4 | 960 | 121.3 h | 0.960 | 7,267.0 | 104,118 | 1,998.4 | swordsman-1 1,265, archer-1 798, spearman-1 797, rider-1 398, archer-2 442, spearman-2 441, rider-2 220, rider-3 123, epic-monster-hunter-5 37, water-elemental 10, battle-boar 4, stone-gargoyle 3, emerald-dragon 3 |
...
**Ten readings**: most damage 8,443,234 · least silver 4,431,600 · fewest hired lost 7.000 · least gold 480 · fewest coins 3,840 · shortest queue 278.7 h · dmg a silver 1.110 · dmg a merc 131,856 · dmg a gold 10,248 · dmg a coin 2,199.
**Bar criteria**: order ✓ · noStopBeaten ✓ · shelter ✓ · sustain ✓ · atMostFive ✓ · sweetSpot ✓ · s58b ✓.
...
## C. The TotalStack benchmark at HEAD, both paths (run 2026-09-24, before the recorder was added)

`pnpm vitest run --project ts tests/engine/plan-benchmark.test.ts` (2 min 50 s) and `--project kernel` (51 s): **10 passed, 9 failed on both paths, the same nine armies** — the known reds: EMH VI ×83, monster tiers 3–5, the 7 000 and 12 000 exports, Aydae alone 4 975, the live camp of 2026-09-18, his localStorage camp, his TotalStack profile, his usual setup. The kernel's `benchmark-latest.kernel.md` equals the TS `benchmark-latest.md` line for line apart from the run stamp and the timing table. The TS run's `benchmark-latest.{md,json}` differed from the committed files only in the run stamp and timings, and were checked out again.

- The benchmark's own matched-spend table (their comparable marches, summed over armies): **68 of 110 dominated**, **13** with no stop inside them; 9 of 17 armies beaten on their hardest march.
- 172's reading (the collector above, B): **70 dominated / 13 no stop fits of 112 rows** — unchanged from 70/13; TotalStack rows no stop beats on damage or rating (162): **2**.

## Runtime

99,457,808 battles walked; 70.9 s in all (planning, walks, reports).
