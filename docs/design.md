...
| `PlanPick: 'most-mercs'` | **Most mercs** | The top of the ladder — the most hired units the troops can shelter, and the most damage a march can do. The dear end of the bar. |
