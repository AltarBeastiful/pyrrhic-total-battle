...
| S-61 The bar's axis: silver or hired burn | flagged | review of 2026-09-16, `out/91-cross-review.md`. Measured on the owner's export at horizon 4: the sweet spot is the same plan on every way of drawing the bar (17 burned, 5 333 606 a march, 21 926 274 a campaign, 2.37 a silver, 313 742 a hired) and moves only under S-58 A (5 518 119 for 2 331 500 silver, same burn, +3.5 % damage, and the 13-burn thrift end no longer drops the legionaries). The current bar draws 12 · 17 · 22 · 22 with the two right-hand stops one plan to 0.2 %; `mergeNear: 0.02` folds them to 12 · 17 · 22; the burn axis draws 12 · 17 · 20 · 22, where the 20 stop is 6 276 006 for the sweet spot's own silver. S-58 B removes the legionary-free `spare-the-stock` from the bar on every axis (the 12-burn plan that fields all four takes its place); A makes it unnecessary by never finding one. Open for the owner: which axis, which S-58 flag, and whether the sweet spot's own rule (the middle of the band's burn range) is what he wants when the 18-burn level buys 5 820 006 for the same silver. |
