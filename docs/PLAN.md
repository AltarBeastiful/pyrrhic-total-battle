...
| S-64 The branches not walked, walked | done | owner, 2026-09-18: *"do the task not walked yet. Never answer from memory, always use theorycrafting … verify the results we produce with the actual engine. See if you can improve more what we generate."* `tools/theorycraft/96-branches.test.ts`, every figure `simulateBattle` on explicit counts, on his export at his setup. **A. Troop subsets under the sizer** — every subset of the seven types his profile fields, under Elite, MS and MS relaxed, with each stop's own mercenaries: **all types win every time**, on damage and on both ratios (the sweet spot: 4 948 511 at 1.81 a silver · 494 851 a hired; no subset beats it). Not added to the search. **B. The ladder's `gap`** — 0.05 to 1: the three stops identical, the campaign identical; with the sizer shapes on, the ladder sizes 0–1 of ~160 plans in the band. Left as is. **C. The finale's shape — the win.** The final march was a ladder over the leftovers: 5 135 846 damage for 3 893 700 silver burning 24; the sizer under MS relaxed over the same leftovers 6 079 432 for 2 739 400 burning 14. The finale is now the best of the ladders *and* the sizer under the three methods, and carries the mercenaries it fields (`ScoredShape.finale.mercs`, so `finaleCounts` is the march that was priced). Measured: the sweet spot's campaign 23 479 307 → **24 814 601** (+5.7 %), silver 12 111 900 → 10 957 600 (−9.5 %), with the three stops unchanged (7 · 10 ★ · 14 at 3 839 332 / 4 948 511 / 6 242 452 a march; at 12 000 leadership 9 · 13 ★ · 17). Search 690 → ~1 000 ms. **D. Leadership held back** — 60–100 % of 7 000 with the shapes on: the sweet spot's damage a hired unit is highest at the full pool (494 851; 467 615 at 5 600), its silver ratio marginally better under it (1.92 at 5 600 against 1.81) for 15 % less damage; no leadership buys both. Left as is. **E. The other objectives** — the band's best a silver is the most-damage stop and its best a hired the thrift end; the search's own best a silver, band or not, is a 1 292 689-damage march for 259 000 silver (4.99 a silver, 143 632 a hired) and its best a hired a 4-burn march at 3 066 260 — the token marches the band exists to refuse. Left as is. |
