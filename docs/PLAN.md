...
| S-70 A silver lever, and the benchmark as a standing test | done | owner, 2026-09-18: *"now the plan almost doesn't change in terms of silver. Are we going in circles?"* and *"always benchmark our total optimization against the two others to understand if we're finding something interesting or just changing numbers"*. Why silver never moved: the search maximises damage, so every shape it scored spent all the leadership, and only the strongest shape a mercenary vector reached the frontier — a cheaper march with the same mercenaries was scored and thrown away. Measured on his live account: the sweet spot's troops at 70 % hit for 5 798 781 against 7 453 778 for 5 427 600 silver against 7 756 500 (1.07 a silver against 0.96). Now every vector's **tight** ladder (scale 1 — every rung just above the mercenaries — over every troop type the leadership pays for) reaches the frontier beside its strongest shape (not the most silver-efficient shape outright, which is a single small stack, the extreme the band refuses), and **Least silver** is the cheapest march of the band left of the sweet spot that costs no more silver and is at least as efficient a silver, and that no other such march beats on both ratios (compared among the marches left of the sweet spot: the tight ladders of one account share one shape and one pair of ratios to the third decimal, and against the whole band the dearest of them beat every cheaper one by a hair). Measured: live account (11 000 leadership by then) 3.9 M / 3.6 M silver · 4.8 M / 5.0 M · 5.0 M / 5.0 M; the 2026-09-17 export at 7 000 gains a least-silver stop at 4 177 683 for 2 178 700 (17 % under the sweet spot's silver, 1.92 a silver), at 12 000 one at 5 766 016 for 3 178 100. **The benchmark is a test now**, `tests/engine/plan-benchmark.test.ts` (owner-gated; its table lands in `tools/theorycraft/out/benchmark-latest.md`): Tier ladder and Troops first, plain and as Generate runs them, against every plan stop over the same four marches, the sizers re-sized each march. Floors: the most-mercs stop within 94 % of the best sizer sequence's damage (measured 94.9–100 %), the plan's best stop a hired unit above every sizer sequence, its best a silver within 95 % of theirs. **Known gap, pinned:** on the 2026-09-17 export at 7 000 the plain Troops-first sequence beats the plan's sweet spot on both ratios (2.14 · 426 216 against 1.95 · 376 087) — the sizer re-sizes each march smaller as the stock drains, a descending sequence the plan cannot express; the pin flips when that shape lands. The search takes 0.3–3.8 s now against 0.7–1.6 s (the frontier holds the tight shapes too). |
