...
| S-63 Under the cap, and the method as a shape | done | owner, 2026-09-17: *"did we try to find a sweet spot inside the 7000 … a better deal that maximizes even more silver/dmg and merc/dmg without filling the authority at max? … is there any branches we don't explore right now?"* Measured on his export (`out/94-under-the-cap.md`): **authority never binds** — the bar is identical from 2 180 down to 400 (the hired side is bounded by the stock and the horizon, 224 authority used at most); **leaving leadership unused is a trade, not a free win** — at 5 000 the most-damage stop's silver ratio is 2.47 against 2.24 at 7 000, for 21 % less damage and 18 % less a hired unit, and damage a hired unit is highest with the whole 7 000; **dropping any one troop type loses on every ratio** (Elite, the sweet spot's own mercenaries: all eight 5 736 190 at 2.09 a silver, the best subset without one type 5 099 143 at 1.94). The branch that *was* missing: the **stacking method** — Military Science over the same eight types hit for 5 770 261 against Elite's 5 736 190 while burning 13 instead of 18. So the sizer shape is scored under Elite, MS and MS relaxed (`SIZER_DEPTHS`, the sizer's own mercenary counts becoming the shape's), and every plan row says which shape sized it (`PlanTotals.shape`). Measured (`out/95-sizer-methods.md`): at 7 000 leadership the bar is 7 · 10 ★ · 14 burned at 3 911 453 / 4 948 511 / **6 242 452** a march for 2 739 400 silver each — the most-damage stop beats the Elite-only one (22 burned, 6 146 761) on damage with eight fewer units burned, 445 889 a hired against 279 398; at 12 000 the sweet spot is 6 879 269 at 13 burned (MS) and the most damage 8 185 823 at 17. The band went from 184 plans to 167, most of them MS relaxed. Search 331 → 689 ms. Branches still not walked, recorded: arbitrary troop subsets with the sizer (only all-types; measured as a loss here), the ladder's `gap`, the finale's shape (ladder only), a plan that leaves leadership unused on purpose, and the objective (always total damage). |
