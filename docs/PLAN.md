...
| S-62 The sizer's own march as a shape the plan can find | done | owner, 2026-09-17: *"are we actually exploring what each additional troop type in the march brings us? … adding them back just brings damage up and cost down"*. Where the search sizes troops: a **ladder** — the strongest `depth` types by damage per HP, one rung each, 2 % apart, scaled — so it fields a *prefix* of that ranking and never any other subset, and its shape is not the Elite sizer's, which is what the March pane re-sizes with after a put-back (`resizeMarch`, elite, the plan's hired counts as caps). `sizerShape` (`CAMPAIGN.planFixes.sizerShape`, **on**) scores the Elite sizer over every troop type as one more shape a mercenary vector. **Reproduced and measured on his export of 2026-09-17** (`out/93-sizer-shape.md`, through `buildPlanRequest`): at his setup (7 000 leadership) the ladder's sweet spot was 4 701 707 damage for 3 142 700 silver without SP1 and ARC1, his put-back march 5 651 382 for 2 739 400 — and that march *is* the Elite sizer over the eight types with the plan's hired caps; with the flag the bar is 12 · 18 ★ · 22 burned at 5 271 151 / 5 736 190 / 6 146 761 a march for 2 739 400 silver each, every stop fielding every troop type and all 7 000 leadership, the campaign 22 176 080 for 12 712 200 silver against 18 689 328 for 13 586 100. At 12 000 leadership (his bar of the morning, reproduced to the unit: 10 · 12 · 19 at 5 681 818 / 6 133 203 / 7 589 745) the flag gives 9 · 13 ★ · 17 at 5 423 667 / 6 842 777 / 8 185 823 for 4 697 600 silver each. Cost: 211 → 331 ms at 7 000, 213 → 399 ms at 12 000. Also fixed: the bar's candidates are the band alone — the refused winner used to be added, and on this export it was a single-troop-stack march (3 495 riders) standing as "Most damage". On the 2026-09-13 file the flag never wins (the ladder over six types beats the sizer there), which is why that file could not show the defect. The recap still shows no damage a hired unit for the march on screen — backlog. |
