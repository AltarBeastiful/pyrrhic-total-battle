...
| S-74 Five stops: the silver saver, the steady max and the all-in sequence | done | owner, 2026-09-18: *"a last stop: all mercs possible, but rename them, and with this one fill all the mercs you can safely. And for one of the stops, a cost-saving silver march using some mercs but just enough troops to shield them while ensuring proper metrics."* `PlanPick` is **silver-saver · sweet-spot · more-mercs · steady-max · all-in**. The silver saver is S-70's least-silver stop, which on every account measured is the tight ladder (every troop rung just above the mercenaries, some of the stock riding with it) — the cost-saving march he described, with its ratios on its row. The steady max is the old top: the most mercenaries the troops shelter *every* march of the horizon. **All in** is new and is the descending sequence the benchmark had found the plan unable to express (`PlanTotals.sequence`): every mercenary the troops can shelter on the first march — the stock tried whole, then at 95 %, 90 %… until a shape shelters it, every hired stack under the lowest troop stack — then each next march on what is left, four marches, ranked by mercenaries fielded first and damage second; offered only when it burns more than the steady max a march. Measured (`out/100`, `benchmark-latest.md`): on his live account it is 83 → 74 → 66 → 59 hunters, 31 218 724 over four marches for 31 092 400 silver — 99 % of the sizers' best sequence (31 495 858) for 32 % less silver, and 3 % over the steady max; at 12 000 leadership on the latest export it is the best campaign outright (28 940 108 against the steady max’s 28 812 258 and the sizers’ 27 838 482). On the four-hired-type accounts it is a worse deal than the steady max (at 7 000: 22 518 504 for 14 337 600 against 24 814 601 for 10 957 600, 93 burned against 64): sheltering 142 hunters costs troop stacks, and the bar shows exactly that. The benchmark test now takes the plan's hardest campaign (steady max or all-in) against the sizers; the pinned gap on the sweet spot stands. |
