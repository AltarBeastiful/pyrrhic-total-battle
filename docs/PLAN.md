...
| S-61 The bar runs along the hired stock; S-58 A on | done | owner's answers of 2026-09-17 to the cross review (`out/91`, `out/92`): the slider is *"about balancing between burning silver efficiently, which is constrained, and burning mercs efficiently, which is constrained as well"*; the sweet spot keeps the middle with no parameter to set; S-58 **A alone**; and a stop "that doesn't come down to anything meaningful and is not very different from the other is inefficient and causes frustration". So the bar's axis is **hired units burned a march** (`CAMPAIGN.planBar.axis: 'burn'`; the silver axis stays behind the flag): one plan a burn level, kept only where burning more buys more (at horizon 3 the band's best at 20 burned hit for 4 938 868 and its best at 17 for 5 314 021 — the sweet spot used to land on the 20); the sweet spot is the middle of that ladder's range; fillers stand in the inner half of the widest gap or are not offered (at horizon 3 the rung nearest the 19→25 gap's middle was 24, 1.1 % from the top); and **the two efficiencies are said on the stops that have them** (`PlanRow.bestFor`, a note under the name) rather than offered as stops — on any account whose mercenaries cost gold, the best damage a silver is the most-damage end (a hired stack adds damage and no silver) and the best damage a hired unit is the thrift end. Measured on the owner's export, A on: horizon 4 draws **12 · 17 · 20 · 22** — 4 107 350 / 5 518 119 ★ / 6 276 006 / 6 920 621 a march for 2 252 000 / 2 331 500 / 2 252 000 / 2 354 500 silver, 622 / 863 / 1 009 / 1 103 gold — every stop at least 9 % of damage and 2 units from its neighbour; horizon 3 draws 13 · 16 · 19 ★ · 25 and horizon 10 draws 9 · 12 ★ · 13 · 15. **Amended the same day from the owner's own bar** (leadership 12 000, three captains; his stops as drawn: 10 burned at 5.7 M / 4.4 M silver / 1.280 a silver / 568 182 a hired, **12 at 6.1 M / 4.6 M / 1.320 / 511 100**, the sweet spot at 15 at 6.6 M / 5.3 M / 1.263 / 442 961, 19 at 7.6 M / 5.4 M / 1.409 / 399 460): *"12 hired lost got better silver/dmg, better dmg/merc and almost the same damage"* — the recommendation lost to the stop beside it on both of the things the slider balances. So the sweet spot and the fillers are read only among the rungs **nothing beats on both efficiencies** (the ends keep their places by definition); on his four stops that leaves 10 · 12 · 19 and the middle of that range is 12. The 2026-09-13 export cannot reproduce his live bar (his linked march hits for 6 133 203 in the app and 4 986 889 under the export's bonuses), so the rule is verified by hand on his figures and on the fixture at horizons 3 · 4 · 10, where the sweet spots stand (19, 17, 12) and horizon 4 loses its 20 filler (beaten by 22 on both ratios). A fresh export is needed to verify it on his account. Known limit: one plan a level loses a same-burn silver trade (horizon 10, 15 burned: 4 903 400 for 1 989 200 against 5 140 277 for 2 351 100 — 18 % of silver for 5 % of damage); it is in the trade the engine hands over, not on the bar. `mergeNearStops` stays as a flag for the silver axis and is not used. |
