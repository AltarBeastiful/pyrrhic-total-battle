/**
 * The provider every kit and domain test renders inside. `env="test"` is Mantine's own switch for
...
/**
 * jsdom implements no scrolling at all, and Mantine's `Combobox` keeps the active option in view on
 * a timer — which fires *after* a test has finished and surfaces as an unhandled `TypeError`. One
 * no-op is the whole fix; nothing in the kit asserts on scrolling.
 */
