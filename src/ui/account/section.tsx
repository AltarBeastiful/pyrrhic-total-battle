/**
 * The account's rows in the account menu (S-49b). Four rows at most, in the order a player meets
 * them: who you are, put a copy on the account, take the copy back, leave.
 *
 ...
 */
import { CloudDownload, CloudUpload, LogIn, LogOut, Mail, UserRound } from 'lucide-react';
